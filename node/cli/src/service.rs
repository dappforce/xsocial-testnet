...
use futures::prelude::*;
use xsocial_runtime::RuntimeApi;
...
pub fn create_extrinsic(
	...
	function: impl Into<xsocial_runtime::RuntimeCall>,
	nonce: Option<u32>,
) -> xsocial_runtime::UncheckedExtrinsic {
	...
	let period = xsocial_runtime::BlockHashCount::get()
		.checked_next_power_of_two()
		.map(|c| c / 2)
		.unwrap_or(2) as u64;
	let tip = 0;
	let extra: xsocial_runtime::SignedExtra = (
		frame_system::CheckNonZeroSender::<xsocial_runtime::Runtime>::new(),
		frame_system::CheckSpecVersion::<xsocial_runtime::Runtime>::new(),
		frame_system::CheckTxVersion::<xsocial_runtime::Runtime>::new(),
		frame_system::CheckGenesis::<xsocial_runtime::Runtime>::new(),
		frame_system::CheckEra::<xsocial_runtime::Runtime>::from(generic::Era::mortal(
			period,
			best_block.saturated_into(),
		)),
		frame_system::CheckNonce::<xsocial_runtime::Runtime>::from(nonce),
		frame_system::CheckWeight::<xsocial_runtime::Runtime>::new(),
		pallet_transaction_payment::ChargeTransactionPayment::<xsocial_runtime::Runtime>::from(tip),
		// pallet_asset_tx_payment::ChargeAssetTxPayment::<xsocial_runtime::Runtime>::from(
		// 	tip, None,
		// ),
	);

	let raw_payload = xsocial_runtime::SignedPayload::from_raw(
		function.clone(),
		extra.clone(),
		(
			(),
			xsocial_runtime::VERSION.spec_version,
			xsocial_runtime::VERSION.transaction_version,
			genesis_hash,
			best_hash,
			(),
			(),
	...
	xsocial_runtime::UncheckedExtrinsic::new_signed(
		function,
		sp_runtime::AccountId32::from(sender.public()).into(),
		xsocial_runtime::Signature::Sr25519(signature),
		extra,
	)
}
